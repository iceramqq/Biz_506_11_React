...
const BBS_FETCG_URL = "http://localhost:5000/api/bbsList";
...
class BBsMain extends Component {
  ...
  componentDidMount() {
    ...
    // 최촉에 callbak함수가 실행되고 이후에
    this.timer = setInterval(() => this.fetchBBsList(), 3000);
  }
  // react에서 set 을 사용하여 어떤 함수를 실행하면
  // 반드시 메서드에서
  // react 가 종
