...
const PhoneMain = () => {
  ...
  // 어느순갅 값이 변화가 된면 화면을 다시 렌더링을 수행한다
  //
  // useState(값) : state 형 변수를 선언하고 초기화시키는 일을 수행
  ...
  변수.current 속성은 state 변수와 달리 아무곳에서나 벼수 값ㅇ르
  수정헐수 있다.
  ref 객체는 값이 변결이 되더라도 react에서 재 
  */
