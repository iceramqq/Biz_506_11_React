...
class BucketMain extends Component {
  ...
  // 실제 db롸 연동을 함녀 이 method에서 Ajax로 서버에 데이터를 전송하고
  // 서버에서는 CRUD를 수행한다.
  ...
  // redering이 되기 ㅏ로직전에 호출되는 method
  //
  componentDidMount() {
  ...
  /**
   * class component 에서 child component에 state형 변수를 보낼때는
   * 보낼변수명={this.state.변수}
   *
   * 함수를 보낼때
   * 보낼함수명 = {this.함수명}
